...
function hideLoadMoreButton() {
  document.getElementById('load_more_button').classList.add('load_more_button_hide');
}


function showLoadMoreButton() {
  document.getElementById('load_more_button').classList.remove('load_more_button_hide');
}
