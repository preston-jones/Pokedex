...
function pokemonInfoCardHeaderTemplateHTML(i) {
  ...
  <div class="close_button_container" onclick="closePokemonInfos()">
          <img class="close_button" src="img/xmark.svg">
        </div>
        ...
        <div onclick="loadPrevPokemonInfoCard(${i})" class="pokemon_button_icon_container" id="prev_pokemon_button_${i}"><img class="pokemon_button_icon" src="img/chevron-left-solid.svg"></div>
          <img class="pokemon_png_info_size" src="${checkImageSrc(loadedPokemonData[i].sprites)}" alt="No Image Found">
          <div onclick="loadNextPokemonInfoCard(${i})" class="pokemon_button_icon_container" id="next_pokemon_button_${i}"><img class="pokemon_button_icon" src="img/chevron-right-solid.svg"></div>
        </div>
  `;
}
